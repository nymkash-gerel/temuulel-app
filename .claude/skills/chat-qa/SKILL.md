...
- [2026-07-20 2-р гүйлт] ЗАСВАР: complaint мөр customer_interactions-д БИЧИГДДЭГ (өмнөх тэмдэглэл буруу байсан — эхний B-гийн нэг мессеж л алгассан). Stock нь чат захиалга үүсэхэд ХАСАГДДАГГҮЙ — pending статустай; confirmed руу шилжихэд хасагдана (status-machine, зориудын дизайн — үүнийг stock шалгалтад бүү хүлээ).
- [2026-07-20 2-р гүйлт] Шинэ олдворууд: (1) "Үнэ хэд вэ?" гэхэд sales_script (хэмжээ/өнгө) буцаасан, ҮНЭ хэлээгүй; (2) sales_script доторх "Хүргэлт үнэгүй" нь checkout-ийн 5,000₮-тэй ЗӨРЧИЛДСӨН — seed/store дата зөрчлийг бас шалгах; (3) "хүргэлт удаж байна" гэсэн эхний гомдлыг shipping_info intent руу буруу чиглүүлж, ерөнхий хүргэлтийн мэдээлэл буцаасан; (4) Сайн: захиалга үүсэхэд DEL-* хүргэлт авто-үүсдэг, статус асуултад хүргэлтийн дугаар олж хариулдаг, "Улаан авъя" гэхэд variant-ыг жагсаалтгүйгээр шууд таньдаг.
- [2026-07-21] (1) ба (2) ЗАСАГДСАН, чатаар дахин батлагдсан: sales_script хариулт одоо "📦 Нэр — үнэ/муж" толгойтой; checkout одоо store-ийн free_delivery_threshold-ыг хүндэтгэдэг (resolveChatDeliveryFee) — 120k захиалгад "Хүргэлт: Үнэгүй 🎉", DB-д shipping_amount=0. Шалгалтад: threshold давсан захиалгын хүргэлт 0 байхыг ХҮЛЭЭ. (3) хэвээр нээлттэй.
-->
