/**
 * Seed all business data via Supabase JS client (no psql needed).
 *
 * Auth users are already created by seed-all-businesses.ts.
 * This script inserts: stores, products, services, staff, bookable_resources.
 *
 * Usage: npx tsx scripts/seed-all-via-api.ts
 */
...
// ============================================================================
// Business definitions (same data as seed-all-data.sql)
// ============================================================================
...
const BUSINESSES = [
  {
    ...
    chatbotSettings: {
      ...
      tone: 'friendly', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#ef4444',
    },
    products: [
      { name: 'Бууз (8ш)', description: 'Уламжлалт монгол бууз, махан чанартай', category: 'Үндсэн хоол', base_price: 12000 },
      { name: 'Хуушуур (4ш)', description: 'Шарсан хуушуур, халуун шинэхэн', category: 'Зууш', base_price: 8000 },
      { name: 'Цуйван', description: 'Монгол шарсан гоймон, ногоотой', category: 'Үндсэн хоол', base_price: 15000 },
      { name: 'Шарсан мах', description: 'Хонины шарсан мах, төмсөнд дэвсэж', category: 'Үндсэн хоол', base_price: 18000 },
      { name: 'Ногоотой салат', description: 'Шинэхэн ногооны салат, заправкатай', category: 'Зууш', base_price: 8000 },
      { name: 'Сүүтэй цай', description: 'Монгол сүүтэй цай (аяга)', category: 'Ундаа', base_price: 3000 },
      { name: 'Бялуу', description: 'Өдрийн шинэхэн бялуу', category: 'Амттан', base_price: 7000 },
      { name: 'Вегетариан хуурга', description: 'Ногоон хүнсний хуурга, тофутай', category: 'Тусгай цэс', base_price: 10000 },
    ],
    services: [],
    staff: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'professional', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'эмч, менежер, яаралтай, оператор, гомдол', accent_color: '#06b6d4',
    },
    products: [],
    services: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'friendly', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#ec4899',
    },
    products: [],
    services: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'casual', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#92400e',
    },
    products: [
      { name: 'Американо', description: 'Классик хар кофе', category: 'Кофе', base_price: 6000 },
      { name: 'Латте', description: 'Эспрессо + сүү, зөөлөн амт', category: 'Кофе', base_price: 7500 },
      { name: 'Капучино', description: 'Эспрессо + сүүн хөөс', category: 'Кофе', base_price: 7000 },
      { name: 'Моча', description: 'Шоколадтай кофе, крем', category: 'Кофе', base_price: 8500 },
      { name: 'Матча латте', description: 'Япон ногоон цайн латте', category: 'Цай', base_price: 8000 },
      { name: 'Ice Americano', description: 'Хүйтэн американо, мөстэй', category: 'Хүйтэн ундаа', base_price: 7000 },
      { name: 'Чизкейк', description: 'Нью-Йорк чизкейк, нэг зүсэм', category: 'Бялуу/Амттан', base_price: 9000 },
      { name: 'Круассан', description: 'Шинэхэн жигнэсэн круассан', category: 'Snack', base_price: 5000 },
    ],
    services: [],
    staff: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'friendly', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#8b5cf6',
    },
    products: [],
    services: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'professional', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, багш, оператор, гомдол', accent_color: '#f59e0b',
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'professional', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'эмч, менежер, яаралтай, оператор, гомдол', accent_color: '#14b8a6',
    },
    products: [],
    services: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'professional', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'агент, менежер, хүн, оператор, гомдол', accent_color: '#10b981',
    },
    products: [
      { name: '2 өрөө орон сууц (Баянгол)', description: '2 өрөө, 55м², 12-р давхар, шинэ засалтай', category: 'Орон сууц', base_price: 95000000 },
      { name: '3 өрөө орон сууц (Сүхбаатар)', description: '3 өрөө, 85м², 7-р давхар, төв байршилтай', category: 'Орон сууц', base_price: 180000000 },
      { name: 'Газар (Налайх 700м²)', description: '700м² газар, гэр хорооллын бүсэд', category: 'Газар', base_price: 45000000 },
      { name: 'Оффис (Чингэлтэй 120м²)', description: '120м² оффис, анхан давхарт, зогсоолтой', category: 'Оффис', base_price: 250000000 },
      { name: '1 өрөө түрээс (ХУД)', description: '1 өрөө, 35м², тавилга бүрэн', category: 'Түрээс', base_price: 650000 },
      { name: '2 өрөө түрээс (БЗД)', description: '2 өрөө, 60м², шинэ засалтай', category: 'Түрээс', base_price: 1200000 },
    ],
    services: [],
    staff: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'friendly', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#84cc16',
    },
    products: [],
    services: [
  ...
  },
  {
    ...
    chatbotSettings: {
      ...
      tone: 'friendly', language: 'mongolian', show_product_prices: true,
      max_product_results: 5, auto_handoff: true,
      handoff_keywords: 'менежер, хүн, оператор, гомдол', accent_color: '#3b82f6',
    ...
    products: [
      { name: 'Кашемир цамц', description: 'Монгол кашемир, эрэгтэй/эмэгтэй, S-XL размер', category: 'Хувцас', base_price: 189000 },
      { name: 'Ноосон малгай', description: 'Монгол ноосон малгай, өвлийн улирал', category: 'Хувцас', base_price: 35000 },
      { name: 'Арьсан цүнх', description: 'Жинхэнэ арьсан гар цүнх', category: 'Хувцас', base_price: 120000 },
      { name: 'Утасгүй чихэвч (Bluetooth)', description: 'ANC чихэвч, 30 цагийн батерей', category: 'Электроник', base_price: 85000 },
      { name: 'Ухаалаг цаг', description: 'Фитнесс трекер, зүрхний цохилт, GPS', category: 'Электроник', base_price: 125000 },
      { name: 'USB-C цэнэглэгч (65W)', description: 'Хурдан цэнэглэгч, зөөврийн компьютерт тохиромжтой', category: 'Электроник', base_price: 45000 },
      { name: 'Нүүрний тос (Витамин C)', description: 'Нүүрний арчилгааны тос, 50мл', category: 'Гоо сайхан', base_price: 28000 },
      { name: 'Шампунь + Кондиционер', description: 'Байгалийн орц найрлагатай, 2х250мл', category: 'Гоо сайхан', base_price: 32000 },
      { name: 'Гэрийн чимэглэл (Зурагтын тавиур)', description: 'Модон ханын тавиур, 3 тавцантай', category: 'Гэр ахуй', base_price: 55000 },
      { name: 'Хүүхдийн тоглоом (Лего)', description: 'Барилгын блок, 150+ хэсэг, 5+ нас', category: 'Хүүхэд', base_price: 42000 },
    ],
    services: [],
    staff: [
...
async function getOrCreateStore(
  ...
  if (existing) {
    ...
    await supabase
      ...
      .update({
        ...
        phone: biz.phone,
        chatbot_settings: biz.chatbotSettings as Record<string, unknown>,
        ai_auto_reply: true,
      })
      .eq('id', existing.id)
    console.log(`  ~ Store updated: ${biz.storeName}`)
    return existing.id
  }
  ...
  console.log(`  + Store created: ${biz.storeName}`)
  return data.id
}

async function seedProducts(
  storeId: string,
  products: ReadonlyArray<{ name: string; description: string; category: string; base_price: number }>
) {
...
async function seedServices(
  ...
  services: ReadonlyArray<{
    ...
    duration_minutes: number; base_price: number; ai_context?: string
  }>
) {
...
async function seedStaff(
  storeId: string,
  staff: ReadonlyArray<{ name: string; phone: string; email: string; specialties: readonly string[] }>
) {
...
async function seedResources(
  ...
  resources: ReadonlyArray<{
    ...
    capacity: number; price_per_unit: number; features: Record<string, unknown>
  }>
) {
  if (resources.length === 0) return
  await supabase.from('bookable_resources').delete().eq('store_id', storeId)
  ...
  const { error } = await supabase.from('bookable_resources').insert(rows)
...
async function main() {
  console.log('=== Seeding stores, products, services, staff, resources via API ===\n')

  let success = 0
  let failed = 0

  for (const biz of BUSINESSES) {
    console.log(`\n[${biz.businessType}] ${biz.storeName}`)

    // 1. Look up user ID from auth
    const { data: authUsers } = await supabase.auth.admin.listUsers()
    const authUser = (authUsers?.users as Array<{ id: string; email?: string }>)?.find((u) => u.email === biz.email)
    if (!authUser) {
      console.log(`  ! Auth user not found for ${biz.email} — skipping`)
      failed++
      continue
    }
    ...
    if (!pubUser) {
      ...
      if (pubErr) {
        console.log(`  ! Public user insert failed: ${pubErr.message}`)
        failed++
        continue
      }
    ...
    try {
      // 3. Upsert store
      const storeId = await getOrCreateStore(userId, biz)

      // 4. Seed data
      await seedProducts(storeId, biz.products)
      await seedServices(storeId, biz.services)
      await seedStaff(storeId, biz.staff)
      await seedResources(storeId, biz.resources)
  ...
  if (success > 0) {
    ...
    BUSINESSES.forEach((b, i) => {
      console.log(`| ${(i + 1).toString().padStart(2)} | ${b.businessType.padEnd(18)} | ${b.email.padEnd(28)} |`)
    })
  }
}
