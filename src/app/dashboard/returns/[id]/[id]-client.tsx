...
export default function ReturnDetailClient({ storeId }: { storeId: string }) {
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/returns" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">
            ←
          </Link>
          <div>
