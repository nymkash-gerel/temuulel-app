...
export default function DailyLogsClient({ initialProjects, initialStaff }: DailyLogsClientProps) {
          ...
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {logs.map((log) => {
                ...
                return (
                  <tr key={log.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
