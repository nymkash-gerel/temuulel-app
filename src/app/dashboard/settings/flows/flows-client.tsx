...
export default function FlowsClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={creating}
            className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300 text-sm rounded-xl transition-colors disabled:opacity-50"
          >
            Загвар ашиглах
          </button>
          <button
      ...
      {/* Template selector */}
      {showTemplates && (
        <div className="mb-6 bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {templates.map((tpl) => (
              <button
                ...
                className="p-3 bg-slate-700/40 hover:bg-white/[0.08]/70 border border-white/[0.06]/50 rounded-xl text-left transition-colors"
              >
        ...
        <div className="space-y-3">
          {flows.map((flow) => {
            ...
            return (
              <div
                key={flow.id}
                className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4 hover:bg-slate-800/70 transition-colors"
              >
