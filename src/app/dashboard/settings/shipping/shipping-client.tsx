...
export default function ShippingSettingsClient({ storeId }: { storeId: string }) {
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-40 px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    />
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-lg border transition-all ${
                          on
                            ...
                            : 'bg-slate-700 text-slate-400 border-white/[0.08] hover:bg-slate-600'
                        }`}
                      >
                        {city}
                      </button>
