...
export default function ProfileSettingsClient({ storeId }: { storeId: string }) {
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            <input
              value={email}
              disabled
              className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-slate-400 text-sm cursor-not-allowed"
            />
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-5">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-6 py-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl font-medium transition-all disabled:opacity-50"
            >
