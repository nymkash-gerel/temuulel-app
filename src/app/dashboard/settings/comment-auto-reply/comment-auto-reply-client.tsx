...
export default function CommentAutoReplyClient({ storeId }: { storeId: string }) {
      ...
      <div className="max-w-4xl mx-auto">
            ...
            {rules.map((rule, _index) => (
              <div
                ...
                className={`bg-white/[0.03] border rounded-2xl p-5 transition-all ${
                  rule.enabled ? 'border-white/[0.06]' : 'border-white/[0.06]/50 opacity-60'
                }`}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="px-2 py-0.5 text-xs rounded-full bg-white/[0.06] text-slate-300">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300 hover:text-white transition-all"
                    >
        ...
        {showEditor && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white/[0.04] border border-white/[0.06] rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                  />
                </div>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border text-sm text-center transition-all ${
                          formTriggerType === type
                            ...
                            : 'border-white/[0.08] bg-white/[0.04] text-slate-300 hover:border-slate-500'
                        }`}
                      >
                  ...
                  {formUseAi && (
                    <div className="mt-4">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-purple-500 transition-all resize-none"
                      />
                    </div>
                  )}
                </div>
                ...
                {formReplyComment && !formUseAi && (
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
                    />
                    <div className="flex gap-2 mt-2">
                      <button
                        type="button"
                        onClick={() => insertVariable('comment', 'user_name')}
                        className="px-3 py-1 text-xs bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300 rounded-lg transition-all"
                      >
                        {'{{user_name}}'}
                      </button>
                    </div>
              ...
              <div className="p-6 border-t border-white/[0.06] flex justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl font-medium transition-all"
                >
                  Болих
                </button>
                <button
