...
export default function CompensationSettingsClient({ storeId }: { storeId: string }) {
        ...
        {CATEGORIES.map(cat => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 pt-4 border-t border-white/[0.06]">
                  <div>
                  ...
                  <div className="flex items-center gap-4 col-span-full">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 rounded border-white/[0.08] bg-white/[0.06] text-blue-500"
                      />
