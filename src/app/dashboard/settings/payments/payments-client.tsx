...
export default function PaymentSettingsClient({ storeId }: { storeId: string }) {
    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-5">
          ...
          {/* Inner city */}
          <div className={`p-4 border rounded-xl transition-all ${innerCityCod ? 'border-emerald-500/30 bg-emerald-500/5' : 'border-white/[0.08] bg-slate-700/20'}`}>
          ...
          {/* Intercity */}
          <div className={`p-4 border rounded-xl transition-all ${intercityPrepay ? 'border-orange-500/30 bg-orange-500/5' : 'border-white/[0.08] bg-slate-700/20'}`}>
            <div className="flex items-start justify-between gap-4">
              <div>
          ...
          <div className="p-3 bg-white/[0.04] border border-white/[0.06]/50 rounded-xl">
