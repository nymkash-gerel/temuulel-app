...
export default function TeamSettingsClient({ storeId }: { storeId: string }) {
    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-6">
            ...
            <>
              <div className="flex gap-3">
                ...
                <select
                  ...
                  className="px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                >
                ...
                <div className="p-4 bg-slate-900/50 rounded-xl space-y-2">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {ALL_PERMISSIONS.map((perm) => (
                      <label
                        key={perm}
                        className="flex items-start gap-3 p-2 rounded-lg hover:bg-white/[0.03] cursor-pointer transition-colors"
                      >
                        <input
                          type="checkbox"
                          checked={invitePerms.has(perm)}
                          onChange={() => toggleInvitePerm(perm)}
                          className="mt-0.5 w-4 h-4 rounded border-white/[0.08] bg-white/[0.06] text-blue-500 focus:ring-blue-500 focus:ring-offset-0"
                        />
                        <div>
        ...
        {pendingInvites.length > 0 && (
          <div className="bg-white/[0.03] border border-yellow-500/20 rounded-2xl divide-y divide-slate-700">
            <div className="p-4">
        ...
        {/* Members List */}
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl divide-y divide-slate-700">
          <div className="p-4">
