...
export default function ChatbotSettingsClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        <Link href="/dashboard/settings" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">
          ←
        </Link>
        <div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 resize-none transition-all"
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-4">
          ...
          <div className="space-y-2">
            {quickReplies.map((reply, i) => (
              <div key={i} className="flex items-center gap-2">
                <span className="flex-1 px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-sm text-slate-300">
                  {reply}
                </span>
                <button
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
            />
            <button
...
function WidgetPreview({
  ...
  return (
    <div className="w-[384px] rounded-2xl overflow-hidden shadow-2xl border border-white/[0.06] bg-slate-900 flex flex-col" style={{ height: '480px' }}>
      {/* Header */}
      <div
      ...
      <div className="p-3 border-t border-white/[0.06]/50 bg-slate-900">
