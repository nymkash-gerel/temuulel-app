...
export default function DeliverySettingsClient({ storeId }: { storeId: string }) {
              ...
              <label
                ...
                className={`flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all ${
                  settings.assignment_mode === mode.value
                    ...
                    : 'border-white/[0.08] bg-white/[0.04] hover:border-slate-500'
                }`}
              >
                <input
                  type="radio"
            ...
            <div className="space-y-2 mb-4">
              {settings.priority_rules.map((ruleValue, index) => {
                ...
                return (
                  <div
                    key={ruleValue}
                    className="flex items-center gap-3 p-3 bg-white/[0.04] border border-white/[0.06] rounded-xl"
                  >
                ...
                <div className="space-y-1">
                  {RULE_OPTIONS.filter(r => !settings.priority_rules.includes(r.value)).map((rule) => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-3 bg-white/[0.03] border border-dashed border-white/[0.08] rounded-xl hover:border-blue-500 hover:bg-blue-500/5 transition-all text-left"
                    >
          ...
          <div className="grid grid-cols-2 gap-4 max-w-xs">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
            <div>
