...
export default function ProductSettingsClient({ storeId }: { storeId: string }) {
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                min={1}
                max={100}
                className="w-24 px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
              />
