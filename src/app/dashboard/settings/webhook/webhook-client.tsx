...
export default function WebhookSettingsClient({ storeId }: { storeId: string }) {
            ...
            {apiKey && (
              <>
                <button
                  ...
                  className="px-3 py-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-lg transition-all"
                >
                  {showApiKey ? '🙈' : '👁️'}
                </button>
                <button
