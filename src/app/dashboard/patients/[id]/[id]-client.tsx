...
export default function PatientDetailClient({ storeId }: { storeId: string }) {
  ...
  const loadPatient = useCallback(async () => {
    ...
    if (data) {
      ...
      setPatient(p)
      await loadChildRecords(storeId)
    }
  ...
  return (
    <div>
      ...
      {medicalHistory && (
        <div className="bg-white/[0.04] rounded-xl p-5 border border-white/[0.06] mb-6">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`px-6 py-3 text-sm font-medium transition-all ${
                activeTab === tab.key
                  ? 'text-blue-400 border-b-2 border-blue-400 bg-white/[0.04]'
                  : 'text-slate-400 hover:text-white hover:bg-white/[0.08]/20'
              }`}
            >
              {tab.label}
              ...
              <table className="w-full min-w-[700px]">
                ...
                <tbody>
                  {encounters.map((enc) => {
                    ...
                    return (
                      <tr key={enc.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
              ...
              <table className="w-full min-w-[500px]">
                ...
                <tbody>
                  {prescriptions.map((rx) => {
                    ...
                    return (
                      <tr key={rx.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
                        <td className="py-3 px-4 text-white text-sm">
              ...
              <table className="w-full min-w-[500px]">
                ...
                <tbody>
                  {medicalNotes.map((note) => (
                    <tr key={note.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
                      <td className="py-3 px-4 text-white text-sm">
