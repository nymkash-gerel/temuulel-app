...
export default function NewPhotoSessionClient({ storeId }: { storeId: string }) {
                        ...
                        <button
                          ...
                          className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                            durationMinutes === String(preset.value)
                              ...
                              : 'bg-white/[0.04] border border-white/[0.06] text-slate-300 hover:bg-white/[0.08] hover:text-white'
                          }`}
                        >
                          {preset.label}
                        </button>
