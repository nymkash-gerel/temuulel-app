...
export default function PhotoSessionDetailClient({ storeId }: { storeId: string }) {
          ...
          {isEditing ? (
            <>
              <button
                ...
                disabled={saving}
                className="px-4 py-2 text-sm font-medium text-slate-300 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] rounded-lg transition-all disabled:opacity-50"
              >
                Болих
              </button>
              <button
            ...
            <button
              onClick={startEdit}
              className="px-4 py-2 text-sm font-medium text-white bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] rounded-lg transition-all"
            >
              Засах
            </button>
          )}
