    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <button onClick={() => router.push('/dashboard/enrollments')} className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">&larr; Буцах</button>
          <div>
        ...
        {editing ? (
          <div className="space-y-4 max-w-lg">
            ...
            <div>
              ...
              <input value={formGrade} onChange={e => setFormGrade(e.target.value)} placeholder="A, B, C..." className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20" />
            </div>
            <div>
