...
export default function EnrollmentsClient({ initialStoreId }: EnrollmentsClientProps) {
  ...
  useEffect(() => {
    ...
    load()
  }, [supabase, loadEnrollments, initialStoreId])
          ...
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              {filtered.map((enrollment) => {
                ...
                return (
                  <tr key={enrollment.id} onClick={() => router.push(`/dashboard/enrollments/${enrollment.id}`)} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all cursor-pointer">
