...
export default function PosSessionsClient({ storeId }: { storeId: string }) {
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full max-w-sm px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-pink-500 transition-all"
              autoFocus
            />
          </div>
