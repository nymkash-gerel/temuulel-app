...
export default function ServiceRequestDetailClient({ storeId }: { storeId: string }) {
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          {!isEditing ? (
            <button
              onClick={startEdit}
              className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white text-sm font-medium rounded-lg transition-colors"
            >
              Засах
            </button>
          ) : (
            <>
              <button
                ...
                disabled={saving}
                className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
              >
                Болих
              </button>
              <button
