...
export default function RatePlanDetailClient({ storeId }: { storeId: string }) {
              ...
              <h1 className="text-2xl font-bold text-white">
                {isEditing ? (
                  <input
                    ...
                    className="bg-white/[0.04] border border-white/[0.06] rounded-lg px-3 py-1 text-white text-2xl font-bold focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                  />
                ) : (
                  plan.name
                )}
          ...
          {isEditing ? (
            <>
              <button
                ...
                disabled={saving}
                className="px-4 py-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300 border border-white/[0.06] rounded-xl text-sm transition-all disabled:opacity-50"
              >
                Cancel
              </button>
              <button
            ...
            <button
              onClick={startEdit}
              className="px-4 py-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300 border border-white/[0.06] rounded-xl text-sm transition-all"
            >
              Edit
            </button>
          )}
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <select
                  ...
                  className="px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                >
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="0"
                  step="0.01"
                  className="w-32 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="0"
                  step="0.01"
                  className="w-32 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 placeholder-slate-500"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-40 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 placeholder-slate-500"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="1"
                  className="w-24 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="1"
                  className="w-24 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 placeholder-slate-500"
                />
              ) : (
            ...
            <table className="w-full min-w-[600px]">
              ...
              <tbody>
                {seasonalAdj.map((adj, idx) => (
                  <tr key={idx} className="border-b border-white/[0.04] hover:bg-white/[0.08]/20 transition-all">
