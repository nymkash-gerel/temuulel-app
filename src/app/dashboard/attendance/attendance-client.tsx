...
export default function AttendanceClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[750px]">
            ...
            <tbody>
              {filtered.map((record) => {
                ...
                return (
                  <tr key={record.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
