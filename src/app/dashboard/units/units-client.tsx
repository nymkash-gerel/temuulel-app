...
export default function UnitsClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              {filtered.map((unit) => {
                ...
                return (
                  <tr key={unit.id} onClick={() => router.push(`/dashboard/units/${unit.id}`)} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all cursor-pointer">
