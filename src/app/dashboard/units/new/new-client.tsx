...
export default function NewUnitClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        <Link href="/dashboard/units" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg">
