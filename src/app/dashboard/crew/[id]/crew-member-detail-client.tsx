...
interface CrewMemberDetailClientProps {
  memberId: string
  initialMember: CrewMember | null
}

export default function CrewMemberDetailClient({ memberId, initialMember }: CrewMemberDetailClientProps) {
  const [member, setMember] = useState<CrewMember | null>(initialMember)
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/crew" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">
            &larr;
          </Link>
          <div>
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all disabled:opacity-50 ${
              member.status === 'active'
                ? 'bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-slate-300'
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
            ...
            <div className="space-y-3 text-sm">
              {member.phone && (
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white/[0.06] rounded-lg flex items-center justify-center text-slate-400">
