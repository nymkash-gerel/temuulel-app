...
export default function TreatmentPlanDetailClient({ storeId }: { storeId: string }) {
    ...
    return (
      <div className="p-6">
        <div className="animate-pulse space-y-4">
          ...
          <div className="h-64 bg-white/[0.06] rounded"></div>
        </div>
      </div>
    )
  }
  ...
  const editInputClass = 'w-full px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500'
