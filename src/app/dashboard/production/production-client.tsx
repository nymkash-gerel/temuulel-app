...
export default function ProductionPlanningClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[950px]">
            ...
            <tbody>
              {filtered.map((batch) => {
                ...
                return (
                  <tr key={batch.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
                    ...
                    <td className="py-3 px-3 md:py-4 md:px-6">
                      <div className="flex items-center gap-3">
                        <div className="flex-1 h-2 bg-white/[0.06] rounded-full overflow-hidden min-w-[60px]">
                          <div
