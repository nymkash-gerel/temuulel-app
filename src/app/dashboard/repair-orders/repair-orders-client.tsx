...
export default function RepairOrdersClient({ storeId }: { storeId: string }) {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    required
                  >
                    <option value="phone">Утас</option>
                    <option value="laptop">Зөөврийн компьютер</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
                  required
                />
              </div>
