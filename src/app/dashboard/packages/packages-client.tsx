...
export default function PackagesClient({ storeId }: { storeId: string }) {
          ...
          <form onSubmit={handleCreate}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-pink-500 transition-all"
                  required
                />
              </div>
              <div>
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-3 cursor-pointer pb-3">
                  <input
                    ...
                    className="w-5 h-5 rounded border-white/[0.08] bg-white/[0.06] text-pink-500"
                  />
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl transition-all"
              >
                Cancel
              </button>
            </div>
          ...
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              {filtered.map((pkg) => {
                ...
                return (
                  <tr key={pkg.id} onClick={() => router.push(`/dashboard/packages/${pkg.id}`)} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all cursor-pointer">
