...
export default function VenuesClient({ storeId }: { storeId: string }) {
          ...
          <form onSubmit={handleCreate}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                  required
                />
              </div>
              <div>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all resize-none"
              />
            </div>
      ...
      {filtered.length > 0 ? (
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl overflow-x-auto">
          <table className="w-full min-w-[750px]">
            ...
            <tbody>
              {filtered.map((venue) => (
                <tr key={venue.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
