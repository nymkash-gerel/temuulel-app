...
export default function EncounterDetailClient({ encounterId }: EncounterDetailClientProps) {
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <button onClick={() => router.push('/dashboard/encounters')} className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">&larr; Буцах</button>
          <div>
          ...
          {editing ? (
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea value={formDiagnosis} onChange={e => setFormDiagnosis(e.target.value)} rows={3} className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 resize-none" placeholder="Оношийг бичнэ үү..." />
              </div>
              <div>
                <label className="block text-sm text-slate-400 mb-1">Эмчилгээний төлөвлөгөө</label>
                <textarea value={formTreatmentPlan} onChange={e => setFormTreatmentPlan(e.target.value)} rows={3} className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 resize-none" placeholder="Эмчилгээний төлөвлөгөө..." />
              </div>
              <div>
