  ...
  return Array.from({ length: 8 }).map((_, i) => (
    <tr key={i} className="border-b border-white/[0.04]">
      ...
      <td className="py-4 px-3 md:px-6 text-center">
        <div className="h-5 w-16 bg-white/[0.06] rounded-full animate-pulse mx-auto" />
      </td>
      <td className="py-4 px-3 md:px-6">
        <div className="h-4 w-24 bg-white/[0.06] rounded animate-pulse" />
      </td>
...
export default function GuestsClient({ storeId }: { storeId: string }) {
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <div className="h-4 w-32 bg-white/[0.06] rounded animate-pulse mt-2" />
          </div>
        </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-pink-500 transition-all"
          />
        </div>
        {search && (
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={page === 0}
                  className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm rounded-lg transition-all"
                >
                  {'\u04e8\u043c\u043d\u04e9\u0445'}
                </button>
                <button
