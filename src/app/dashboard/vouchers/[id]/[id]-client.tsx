...
export default function VoucherDetailClient({ storeId }: { storeId: string }) {
          ...
          {voucher.complaint_summary && (
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              ...
              <div className="mb-4">
                ...
                <span className="px-3 py-1 bg-white/[0.06] text-slate-300 rounded-full text-sm">
                  {CATEGORY_LABELS[voucher.complaint_category] || voucher.complaint_category}
                </span>
              </div>
              <div>
              ...
              {voucher.conversation_id && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl text-sm transition-all"
                >
                  💬 Чат харах
                </Link>
              )}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
                    />
                  </div>
