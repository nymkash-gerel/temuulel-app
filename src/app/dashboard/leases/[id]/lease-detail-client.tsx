...
export default function LeaseDetailClient({ initialLease, leaseId }: LeaseDetailClientProps) {
  const router = useRouter()

  const [lease, setLease] = useState<Lease>(initialLease)
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-48 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  placeholder="+976 ..."
                  className="w-48 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 placeholder-slate-500"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="0"
                  step="0.01"
                  className="w-36 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
                />
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  min="0"
                  step="0.01"
                  className="w-36 px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm text-right focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 placeholder-slate-500"
                />
              ) : (
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 mb-6">
        ...
        {isEditing ? (
          <textarea
            ...
            className="w-full px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-slate-500"
          />
        ) : (
