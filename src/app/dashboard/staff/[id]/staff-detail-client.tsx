        ...
        <div className="space-y-2">
          ...
          {link ? (
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleCopy}
                className="px-3 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white text-xs rounded-lg transition-all whitespace-nowrap"
              >
...
export default function StaffDetailClient({ staffId }: StaffDetailClientProps) {
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <button onClick={() => router.push('/dashboard/staff')} className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg transition-all">&larr; Буцах</button>
          <div>
        ...
        {editing ? (
          <div className="space-y-4 max-w-lg">
            ...
            <div>
              ...
              <input value={formSpecialties} onChange={e => setFormSpecialties(e.target.value)} className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20" />
            </div>
            <div>
