...
export default function PackagePurchasesClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {purchases.map((p) => {
                ...
                return (
                  <tr key={p.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
