...
export default function StockTransferDetailClient({ storeId }: { storeId: string }) {
              ...
              <tbody>
                {items.map((item, idx) => {
                  const itemProgress = item.quantity > 0
                    ...
                    : 0
                  return (
                    <tr key={item.id} className="border-b border-white/[0.04] hover:bg-white/[0.08]/20 transition-all">
