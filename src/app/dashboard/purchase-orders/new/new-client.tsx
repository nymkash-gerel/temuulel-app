...
export default function NewPurchaseOrderClient({ storeId }: { storeId: string }) {
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div>
                        ...
                        <div className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-slate-300">
