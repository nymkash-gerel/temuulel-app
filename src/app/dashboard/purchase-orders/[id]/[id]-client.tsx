...
export default function PurchaseOrderDetailClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-full px-3 py-1.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              ) : (
        ...
        {/* Notes Card */}
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 md:col-span-2">
