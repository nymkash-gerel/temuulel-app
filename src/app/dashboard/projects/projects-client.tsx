...
export default function ProjectsClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[1100px]">
            ...
            <tbody>
              {projects.map((project) => {
                ...
                return (
                  <tr key={project.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
