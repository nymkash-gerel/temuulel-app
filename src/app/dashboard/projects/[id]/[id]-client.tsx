...
export default function ProjectDetailClient({ storeId }: { storeId: string }) {
          ...
          {!isEditing ? (
            ...
            <>
              <button
                ...
                disabled={saving}
                className="px-4 py-2 bg-slate-600 hover:bg-white/[0.08] text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
              >
                Болих
              </button>
              <button
            ...
            <table className="w-full min-w-[800px]">
              ...
              <tbody>
                {tasks.map((task) => {
                  ...
                  return (
                    <tr key={task.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
