...
interface DriverPayoutDetailClientProps {
  payoutId: string
  initialStoreId: string
}

export default function DriverPayoutDetailClient({ payoutId, initialStoreId }: DriverPayoutDetailClientProps) {
  ...
  }, [payoutId, initialStoreId, supabase, router])
