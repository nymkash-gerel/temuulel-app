...
interface DeskBookingDetailClientProps {
  bookingId: string
  initialStoreId: string
}

export default function DeskBookingDetailClient({ bookingId, initialStoreId }: DeskBookingDetailClientProps) {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(false)
  }, [bookingId, initialStoreId, supabase, router])
  ...
  async function handleSave() {
    ...
    try {
      ...
      const res = await fetch(`/api/desk-bookings/${bookingId}`, {
        method: 'PATCH',
