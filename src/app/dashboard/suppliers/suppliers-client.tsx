          ...
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {filtered.map((supplier) => (
                <tr key={supplier.id} onClick={() => router.push(`/dashboard/suppliers/${supplier.id}`)} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all cursor-pointer">
