...
export default function StaffCommissionsClient({ storeId }: { storeId: string }) {
          ...
          <table className="w-full min-w-[950px]">
            ...
            <tbody>
              {commissions.map((c) => {
                ...
                return (
                  <tr key={c.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
