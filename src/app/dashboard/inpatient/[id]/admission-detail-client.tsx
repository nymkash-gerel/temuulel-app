...
export default function AdmissionDetailClient({ id, storeId }: { id: string; storeId: string }) {
            ...
            <table className="w-full min-w-[500px]">
              ...
              <tbody>
                {admission.bed_assignments.map(ba => (
                  <tr key={ba.id} className="border-b border-white/[0.04] hover:bg-white/[0.08]/20 transition-colors">
