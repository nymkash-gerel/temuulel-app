...
export default function EventBookingDetailClient({ id }: { id: string }) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl text-sm transition-all"
          >
            {editing ? 'Болих' : 'Засах'}
          </button>
              ...
              Array.isArray(menuSelection) ? (
                <div className="space-y-2">
                  {menuSelection.map((item, i) => (
                    <div key={i} className="flex items-center gap-2 p-3 bg-white/[0.04] rounded-xl">
                ...
                <div className="space-y-2">
                  {Object.entries(menuSelection).map(([key, value]) => (
                    <div key={key} className="flex items-center justify-between p-3 bg-white/[0.04] rounded-xl">
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {booking.event_timeline.map((milestone) => (
                  <div key={milestone.id} className="p-3 bg-white/[0.04] rounded-xl">
