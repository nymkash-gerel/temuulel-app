    ...
    <div>
      ...
      {filtered.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map((event) => (
            <div key={event.id} className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 hover:border-white/[0.1] transition-all">
              ...
              {event.notes && (
                <p className="mt-4 text-slate-400 text-xs border-t border-white/[0.06] pt-3 line-clamp-2">
                  {event.notes}
                </p>
              )}
            </div>
