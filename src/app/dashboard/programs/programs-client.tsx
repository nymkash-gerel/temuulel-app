...
export default function ProgramsClient({ storeId }: { storeId: string }) {
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-3 cursor-pointer pb-3">
                  <input
                    ...
                    className="w-5 h-5 rounded border-white/[0.08] bg-white/[0.06] text-blue-500"
                  />
          ...
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {filtered.map((program) => (
                <tr key={program.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
