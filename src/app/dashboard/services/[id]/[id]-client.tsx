...
export default function EditServiceClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        <Link href="/dashboard/services" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg">
              ...
              {variations.length === 0 ? (
                ...
                <div className="space-y-4">
                  {variations.map((variation, index) => (
                    <div key={variation.id} className="p-4 bg-white/[0.04] rounded-xl">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <input
                          ...
                          className="px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-pink-500 text-sm"
                      ...
                      <div className="mt-3">
                        <label className="flex items-center gap-2">
                          <input
                            ...
                            className="rounded border-white/[0.08] bg-white/[0.06] text-pink-500 focus:ring-pink-500"
                          />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl p-6">
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 bg-white/[0.03] border border-purple-500/30 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
