...
interface NewLaundryOrderClientProps {
  initialCustomers: Customer[]
}

export default function NewLaundryOrderClient({ initialCustomers }: NewLaundryOrderClientProps) {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              ...
              <div className="space-y-4">
                {items.map((item, index) => (
                  <div key={item.id} className="p-4 bg-white/[0.04] rounded-xl">
