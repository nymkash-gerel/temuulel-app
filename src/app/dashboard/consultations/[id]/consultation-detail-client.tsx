...
export default function ConsultationDetailClient({ id, storeId }: { id: string; storeId: string }) {
          ...
          {isEditing ? (
            <>
              <button
                ...
                className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white text-sm font-medium rounded-xl transition-all"
              >
                Болих
              </button>
              <button
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-white mt-1">
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-white/[0.06] text-slate-200">
