...
export default function ImportProductsClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        <Link href="/dashboard/products" className="p-2 text-slate-400 hover:text-white hover:bg-white/[0.08] rounded-lg">←</Link>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
          ...
          <div className="border-2 border-dashed border-white/[0.08] rounded-xl p-8 text-center mb-4">
            <input
              type="file"
              accept=".csv,.xlsx,.xls"
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
          ...
          <ul className="text-sm text-slate-300 space-y-1 mb-4">
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">name</code> - Нэр (заавал)</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">price</code> - Үнэ (заавал)</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">stock</code> - Нөөц</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">category</code> - Ангилал</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">description</code> - Тайлбар</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">size</code> - Хэмжээ</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">color</code> - Өнгө</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">facebook_post_id</code> - Facebook Post ID</li>
            <li><code className="bg-white/[0.06] px-2 py-0.5 rounded">instagram_post_id</code> - Instagram Post ID</li>
          </ul>
          ...
          <button
            ...
            className="mt-4 w-full py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl text-sm"
          >
            Жишээ файл татах
          </button>
        </div>
