...
export default function SubscriptionDetailClient({ storeId }: { storeId: string }) {
  ...
  return (
    <div>
              ...
              {isEditing ? (
                <label className="flex items-center gap-2 mt-1">
                  <input
                    ...
                    className="w-4 h-4 rounded border-white/[0.08] bg-white/[0.04] text-blue-500 focus:ring-2 focus:ring-blue-500"
                  />
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl overflow-hidden mb-6">
        <h2 className="p-4 text-lg font-semibold text-white border-b border-white/[0.06]">
        ...
        {items.length > 0 ? (
          <table className="w-full">
            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.id} className="border-b border-white/[0.04] hover:bg-white/[0.04] transition-all">
      ...
      <div>
        <Link
          href="/dashboard/subscriptions"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl text-sm transition-all"
        >
