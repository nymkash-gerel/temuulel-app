    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-white rounded-xl text-sm transition-all inline-flex items-center gap-2"
        >
              ...
              <div className="space-y-3">
                {columns[col.key].map((ticket) => {
                  ...
                  return (
                    <div
                      key={ticket.id}
                      className="bg-slate-950/80 border border-white/[0.06] rounded-xl p-4 hover:border-white/[0.1] transition-all"
                    >
                      {/* Ticket Header */}
