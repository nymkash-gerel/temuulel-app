...
export default function ChatConversationClient({ id }: { id: string }) {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex">
      ...
      <div className="flex-1 flex flex-col">
        {/* Chat Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06] bg-slate-800/30">
          ...
          <div className="flex items-center gap-3">
            ...
            {conversation.customers?.id && (
              <Link
                ...
                className="px-3 py-1.5 text-sm text-slate-400 hover:text-white bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] rounded-lg transition-all"
              >
                Дэлгэрэнгүй
              </Link>
            )}
                ...
                <div
                  className={`max-w-[70%] rounded-2xl px-4 py-3 ${
                    msg.is_from_customer
                      ? 'bg-white/[0.04] text-white rounded-bl-md'
                      : msg.is_ai_response
        ...
        {/* Quick Replies */}
        {showQuickReplies && (
          <div className="px-6 py-3 border-t border-white/[0.06]/50 bg-slate-800/30">
            ...
            <div className="flex flex-wrap gap-2">
              {QUICK_REPLIES.map((reply, i) => (
                <button
                  ...
                  className="px-3 py-1.5 bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 text-sm rounded-lg border border-white/[0.06] transition-all"
                >
                  {reply}
                </button>
              ))}
        ...
        {/* Message Input */}
        <div className="px-6 py-4 border-t border-white/[0.06] bg-slate-800/30">
          <div className="flex items-end gap-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="p-2.5 bg-white/[0.04] text-amber-400 hover:bg-amber-500/20 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                rows={1}
                className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06] rounded-xl text-white text-sm placeholder-slate-400 focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20 resize-none transition-all"
              />
            </div>
      ...
      <div className="hidden xl:block w-72 border-l border-white/[0.06] bg-slate-800/20 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full py-2 text-sm text-slate-300 hover:text-white bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] rounded-lg transition-all"
            >
