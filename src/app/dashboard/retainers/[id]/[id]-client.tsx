...
export default function RetainerDetailClient({ storeId }: { storeId: string }) {
          ...
          {isEditing ? (
            <div className="space-y-3">
              <select
                ...
                className="w-full px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-white text-sm focus:outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/20"
              >
