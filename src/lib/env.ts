...
function validateEnv(): ServerEnv {
  ...
  return (result.success ? result.data : serverSchema.parse({
    ...
    NEXT_PUBLIC_SUPABASE_ANON_KEY: (process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? process.env.NEXT_PUBLIC_SUPABASE_KEY) || 'dev-anon-key',
    SUPABASE_SERVICE_ROLE_KEY: (process.env.SUPABASE_SERVICE_ROLE_KEY ?? process.env.SUPABASE_SECRET_KEY) || 'dev-service-key',
