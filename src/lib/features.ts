...
const MODULE_REGISTRY: Record<string, NavItem> = {
  overview:       { href: '/dashboard',              icon: '📊', label: 'Тойм',               labelKey: 'nav.overview' },
  products:       { href: '/dashboard/products',     icon: '📦', label: 'Бүтээгдэхүүн',       labelKey: 'nav.products' },
  menu:           { href: '/dashboard/menu',         icon: '🍽️', label: 'Меню',               labelKey: 'nav.menu' },
  properties:     { href: '/dashboard/products',     icon: '🏠', label: 'Зар',                labelKey: 'nav.properties' },
  orders:         { href: '/dashboard/orders',       icon: '🛒', label: 'Захиалга',            labelKey: 'nav.orders' },
  calendar:       { href: '/dashboard/calendar',     icon: '📅', label: 'Цагийн хуваарь',     labelKey: 'nav.calendar' },
  services:       { href: '/dashboard/services',     icon: '💅', label: 'Үйлчилгээ',          labelKey: 'nav.services' },
  staff:          { href: '/dashboard/staff',        icon: '👩‍💼', label: 'Ажилтан',            labelKey: 'nav.staff' },
  agents:         { href: '/dashboard/staff',        icon: '👩‍💼', label: 'Агентууд',           labelKey: 'nav.agents' },
  resources:      { href: '/dashboard/resources',    icon: '🪑', label: 'Нөөц',               labelKey: 'nav.resources' },
  deals:          { href: '/dashboard/deals',        icon: '📋', label: 'Хэлцэл',             labelKey: 'nav.deals' },
  commissions:    { href: '/dashboard/commissions',  icon: '💰', label: 'Комисс',             labelKey: 'nav.commissions' },
  deliveries:     { href: '/dashboard/deliveries',   icon: '🚚', label: 'Хүргэлт',            labelKey: 'nav.deliveries' },
  driver_payouts: { href: '/dashboard/driver-payouts', icon: '💸', label: 'Жолоочийн төлбөр', labelKey: 'nav.driverPayouts' },
  returns:        { href: '/dashboard/returns',      icon: '↩️', label: 'Буцаалт',            labelKey: 'nav.returns' },
  vouchers:       { href: '/dashboard/vouchers',     icon: '🎫', label: 'Ваучер',             labelKey: 'nav.vouchers' },
  customers:      { href: '/dashboard/customers',    icon: '👥', label: 'Үйлчлүүлэгч',       labelKey: 'nav.customers' },
  chat:           { href: '/dashboard/chat',         icon: '💬', label: 'Чат',                labelKey: 'nav.chat' },
  driver_chat:    { href: '/dashboard/driver-chat',  icon: '🗨️', label: 'Жолоочтой чат',     labelKey: 'nav.driverChat' },
  billing:        { href: '/dashboard/billing',      icon: '🧾', label: 'Нэхэмжлэл',         labelKey: 'nav.billing' },
  analytics:      { href: '/dashboard/analytics',    icon: '📈', label: 'Тайлан',             labelKey: 'nav.analytics' },
  ai_learning:    { href: '/dashboard/ai-learning',  icon: '🧠', label: 'AI Суралцах',        labelKey: 'nav.aiLearning' },
  broadcast:      { href: '/dashboard/broadcast',    icon: '📢', label: 'Broadcast',          labelKey: 'nav.broadcast' },
  message_usage:  { href: '/dashboard/message-usage', icon: '💬', label: 'Мессеж',            labelKey: 'nav.messageUsage' },
  ab_tests:       { href: '/dashboard/ab-tests',     icon: '🧪', label: 'A/B Тест',           labelKey: 'nav.abTests' },
  churn:          { href: '/dashboard/churn',        icon: '📉', label: 'Churn',              labelKey: 'nav.churn' },
  subscription:   { href: '/dashboard/subscription', icon: '💳', label: 'Захиалга',           labelKey: 'nav.subscription' },
  referrals:      { href: '/dashboard/referrals',    icon: '🎁', label: 'Найз урих',          labelKey: 'nav.referrals' },
  settings:       { href: '/dashboard/settings',     icon: '⚙️', label: 'Тохиргоо',          labelKey: 'nav.settings' },
  // QSR / Restaurant
...
const DEFAULT_MODULES: Record<string, string[]> = {
  ...
  ecommerce: [
    ...
    'billing', 'analytics', 'ai_learning', 'broadcast', 'message_usage', 'churn', 'ab_tests', 'subscription', 'referrals', 'settings',
  ],
  // Food-based
  restaurant: [
    ...
    'customers', 'chat', 'driver_chat', 'billing', 'analytics', 'ai_learning', 'broadcast', 'message_usage', 'churn', 'ab_tests', 'subscription', 'referrals', 'settings',
  ],
  coffee_shop: [
  ...
  hospital: [
    ...
    'customers', 'chat', 'billing', 'analytics', 'ai_learning', 'broadcast', 'message_usage', 'churn', 'ab_tests', 'subscription', 'referrals', 'settings',
  ],
  dental_clinic: [
  ...
  training_center: [
    ...
    'staff', 'customers', 'chat', 'billing', 'analytics', 'ai_learning', 'broadcast', 'message_usage', 'churn', 'ab_tests', 'subscription', 'referrals', 'settings',
  ],
  // Pet Services
  pet_services: [
  ...
  repair_shop: [
    ...
    'chat', 'billing', 'analytics', 'ai_learning', 'broadcast', 'message_usage', 'churn', 'ab_tests', 'subscription', 'referrals', 'settings',
  ],
