...
- Хэрэглэгч бүтээгдэхүүн сонгосны дараа СИСТЕМ АВТОМАТААР захиалга цуглуулна (хаяг, утас авна).
- Тиймээс чи зөвхөн бүтээгдэхүүнийг сайн танилцуулж, "захиалмаар байвал бичнэ үү!" гэж хэл.
- Хаяг, утас, баталгаажуулалтыг ЧИ АСУУХГҮЙ — систем автоматаар асууна.
