...
- Хэрэглэгч 2 бараа ХАМТ авах нь хямдардаг уу гэвэл — жагсаалтад сет/bundle бараа байвал тэрийгээ дурдаж үнийн харьцуулалт хий. Жишээ: "Тийм! Цамц+Өмд сет 39,000₮, тусдаа авахаасаа 11,000₮ хэмнэнэ 🎁"${noProductsRule}`
