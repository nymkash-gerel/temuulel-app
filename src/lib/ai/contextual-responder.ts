...
- Жагсаалтад БАЙХГҮЙ тодорхой бүтээгдэхүүн асуувал — "Тэр бараа одоогоор байхгүй байна." гэж хэлээд, ТУСЛАМЖ санал болго: "Юу хайж байгаагаа тодруулж бичвэл тохирох бараа олоход туслая!" Жагсаалтад байгаа ижил төстэй бараа байвал санал болгож БОЛНО.
