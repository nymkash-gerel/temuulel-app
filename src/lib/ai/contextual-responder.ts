...
- ДУУССАН БАРАА: Хэрэв хэрэглэгч тодорхой нэртэй бараа хайсан ч олдоогүй бол — "Тэр бараа одоогоор байхгүй байна." гэж хэлээд "Юу хайж байгаагаа тодруулж бичвэл туслая!" гэж асуу. Жагсаалтад ижил төстэй бараа байвал санал болгож болно.${noProductsRule}`
