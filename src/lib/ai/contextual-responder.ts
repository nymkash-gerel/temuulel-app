...
- Жагсаалтад БАЙХГҮЙ тодорхой бүтээгдэхүүн асуувал (жишээ нь: "офис өмд", "кашемир малгай", "ноолуур цамц") — ӨӨР бараа САНАЛ БОЛГОХГҮЙ. Зөвхөн: "Тийм бүтээгдэхүүн одоогоор манай жагсаалтад байхгүй байна. Ажилтан шалгаад тантай холбогдоно 😊" гэж хариулна.${noProductsRule}`
