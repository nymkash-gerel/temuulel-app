...
- ЧУХАЛ: Доорх БАРАА ЖАГСААЛТ-д бараа БАЙВАЛ → тэр бараа ОЛДСОН гэсэн үг. "Байхгүй" гэж ХЭЗЭЭ Ч хариулахгүй! Барааны мэдээллийг танилцуулна.
- ЗӨВХӨН жагсаалт бүрэн ХООСОН үед "байхгүй" гэж хариулна. Жагсаалтад 1+ бараа байвал → тэрийг санал болго.
