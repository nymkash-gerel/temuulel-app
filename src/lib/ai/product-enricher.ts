...
Чухал зааварууд:
- search_aliases: 5-8 ширхэг ЧАНАРТАЙ alias. Дараах төрлүүдийг оруул:
  1. Утга ижил нэршил (корсет = бие барих = шейпер)
  2. Англи нэр (bodyshaper, shapewear)
  3. Брэндийн товчлол (скимс = SKIMS)
  4. Messenger дээр хэрэглэгч яаж бичдэг (бие барих цамц)
  5. Ангиллын ерөнхий нэр (хувцас, гутал)
  БҮҮР оруулахгүй: Механик typo (sxms, skimss), Latin→Cyrillic хувилбар (систем автомат хийнэ), хэт ерөнхий үг (бараа, зүйл).
  Жишээ: "SKIMS Хуулбарууд 1+1" → ["скимс", "bodyshaper", "body shaper", "shapewear", "бие барих", "шейпер", "корсет", "хуулбар"]
