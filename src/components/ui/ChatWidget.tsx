...
export default function ChatWidget({
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div ref={widgetRef} role="dialog" aria-label={`${storeName} чат`} className={`fixed z-50 flex flex-col overflow-hidden shadow-2xl ${
          compact
          ...
          {/* Messages */}
          <div ref={messagesContainerRef} aria-live="polite" aria-label="Мессежүүд" className="flex-1 overflow-y-auto overscroll-contain p-4 space-y-3 bg-gray-50">
            {messages.length === 0 && (
              welcomeMessage ? (
            ...
            {sending && (
              <div className="flex justify-start" aria-busy="true" aria-label="Бодож байна...">
